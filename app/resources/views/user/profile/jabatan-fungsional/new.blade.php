    ...
    <div class="card p-3">
        ...
        <div class="table-responsive">
            <table class="table mt-2 border" style="font-size: 14px">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="w-100 form-control form-control-sm" placeholder="Contoh: 03/PL30/SK/D/2018">
                ...
                <tr>
                    ...
                    <td>
                        <input type="date" class="w-100 form-control form-control-sm">
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="row">
            ...
            <div class="col border pb-3 pl-0 pr-0" style="font-size: 14px">
                <p class="bg-secondary p-1 pl-2 font-weight-bold">SK Jabatan Fungsional</p>
                <div class="pl-2 pr-2">
