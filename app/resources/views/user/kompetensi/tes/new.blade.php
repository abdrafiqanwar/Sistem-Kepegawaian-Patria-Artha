...
@section('content')
    <div class="card p-3">
        <div class="d-flex justify-content-between">
            <h5 class="text-bold">Form Tambah Tes</h5>
            <a href="{{ route('user.tes') }}" class="btn btn-secondary btn-sm mt-auto mb-auto" style="font-size: 12px; fill: white">
        ...
        <div class="table-responsive">
            <table class="table mt-2 border" style="font-size: 14px">
                ...
                <tr>
                    <th class="w-25">Nama Tes</th>
                    <td>
                        <input type="text" class="w-100 form-control form-control-sm">
                    </td>
                </tr>
                <tr>
                    <th class="w-25">Penyelenggara</th>
                    <td>
                        <input type="text" class="w-100 form-control form-control-sm">
                    </td>
                </tr>
                <tr>
                    <th class="w-25">Tanggal Tes</th>
                    <td>
                        <input type="text" class="w-100 form-control form-control-sm">
                    </td>
                </tr>
